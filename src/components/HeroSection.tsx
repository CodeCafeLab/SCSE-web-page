...
export const HeroSection = ({ timeLeft, offerEnded }: HeroSectionProps) => {
  ...
  if (
    ...
    !document.getElementById("gallery-styles")
  ) {
          ...
          <div className="grid gap-10 lg:gap-12 xl:gap-16 items-center lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)]">
            ...
            <div className="text-center lg:text-left space-y-4 sm:space-y-5 md:space-y-6">
              ...
              <p className="text-sm xs:text-base sm:text-lg text-white/90 max-w-2xl mx-auto lg:mx-0 pt-2">
                Get certified in just 3 weeks and launch your career in the
                solar industry. Limited seats available!
              </p>
              ...
              <div className="flex flex-col xs:flex-row flex-wrap gap-3 sm:gap-4 pt-3 sm:pt-4">
                <Button
                  ...
                  className="w-full xs:w-auto flex-1 sm:flex-none bg-blue-600 hover:bg-blue-700 text-white font-bold text-sm sm:text-base md:text-lg px-4 sm:px-6 py-3 sm:py-4 md:py-5 rounded-lg sm:rounded-xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1"
                >
                  Book Your Seat Now{" "}
              ...
              <div className="pt-2">
                <div className="inline-flex items-center px-3 sm:px-4 py-1.5 sm:py-2 bg-white/10 backdrop-blur-sm rounded-full text-xs sm:text-sm md:text-base">
                  ...
                  Next batch starts:{" "}
                  <span className="font-semibold ml-1">01 Jan 2026</span>
                </div>
              </div>
            </div>
            ...
            <div className="text-center space-y-3">
              ...
              <div className="flex flex-wrap justify-center gap-2 sm:gap-3 md:gap-4">
                <div className="flex flex-col items-center min-w-[50px] sm:min-w-[60px]">
                  ...
                  <span className="text-[10px] sm:text-xs md:text-sm opacity-80">
                    Days
                  </span>
                </div>
                <div className="flex items-center text-xl sm:text-2xl md:text-3xl font-bold">
                  :
                </div>
                <div className="flex flex-col items-center min-w-[50px] sm:min-w-[60px]">
                  <span className="text-xl sm:text-2xl md:text-3xl font-bold">
